...
function FaceSwapReqModal({ isVisible, toggle, onSend, data }) {
    return (
        <>
            <Modal
                isVisible={isVisible}
            >
                <View style={styles.modalContainer}>
                    <View style={styles.firstContainer}>
                        <TextView style={styles.usrTxt}>{data?.name}</TextView>
                    </View>
                    <View style={styles.secondContainer}>
                        <View style={styles.sendIconContainer}>
                            <FastImage source={sendIcon} style={styles.sendIcon} resizeMode={FastImage.resizeMode.contain} />
                        </View>
                        <TextView style={styles.msgTxt}>Hello is locked. To use this, send request to this user.</TextView>
                        <View style={styles.btnContainer}>
                            <Button rounded style={styles.okBtn} onPress={toggle}>
                                <TextView style={styles.btnText}>CANCEL</TextView>
                            </Button>
                            <Button rounded style={styles.editBtn} onPress={() => {
                                onSend()
                            }}>
                                <TextView style={styles.btnText}>SEND</TextView>
                            </Button>
                        </View>
                    </View>
                </View>
...
export default FaceSwapReqModal